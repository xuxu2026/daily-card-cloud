...
# 8色系交叉排列（2026-04-15修复）
# 公式: 第p天 → series=p//8+1, group=p%8, idx=series+group*9
# 效果: 每天一个完整色系轮转（9天完成一轮72天完成一周期）
# 旧排列每9天同色系 → 新排列每天换色系
REGULAR_STYLES = [
    # 第1轮: 珊瑚(A)→鼠尾草(B)→天青蓝(C)→薰衣草(D)→玫瑰(E)→奶油(F)→薄荷(G)→琥珀(H)
    S.S01, S.S10, S.S19, S.S28, S.S37, S.S46, S.S55, S.S64,
    # 第2轮
    S.S02, S.S11, S.S20, S.S29, S.S38, S.S47, S.S56, S.S65,
    # 第3轮
    S.S03, S.S12, S.S21, S.S30, S.S39, S.S48, S.S57, S.S66,
    # 第4轮
    S.S04, S.S13, S.S22, S.S31, S.S40, S.S49, S.S58, S.S67,
    # 第5轮
    S.S05, S.S14, S.S23, S.S32, S.S41, S.S50, S.S59, S.S68,
    # 第6轮
    S.S06, S.S15, S.S24, S.S33, S.S42, S.S51, S.S60, S.S69,
    # 第7轮
    S.S07, S.S16, S.S25, S.S34, S.S43, S.S52, S.S61, S.S70,
    # 第8轮
    S.S08, S.S17, S.S26, S.S35, S.S44, S.S53, S.S62, S.S71,
    # 第9轮
    S.S09, S.S18, S.S27, S.S36, S.S45, S.S54, S.S63, S.S72,
]
